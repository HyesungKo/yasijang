    ...
    return (
        <>
            <div id="contact" className="container mx-auto py-18">
                <h2 className="text-center lg:text-5xl text-5xl mt-10 font-bold" style={{color: "#10233e"}}>Contact Us</h2>
            ...
            <div className="pt-20">
                <h2 className="w-full text-center text-3xl font-black pb-5" style={{color: "#10233e"}}>LOCATION</h2>
