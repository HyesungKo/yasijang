export default function About() {
    return (
        <div className="relative container mx-auto top-80 text-white">
            <h2 className="w-full text-center px-5 text-4xl font-black pb-5">Welcome to Yasijang!</h2>
            <p className="w-100 xl:mx-60 px-5 text-center text-lg font-semibold">
