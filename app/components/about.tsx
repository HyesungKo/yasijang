export default function About() {
    return (
        <div id="about" className="relative container mx-auto top-80 text-white">
            <h2 className="w-full text-center text-3xl font-black pb-5">Welcome to Yasijang!</h2>
            <p className="w-100 xl:mx-60 mx-5 text-center text-lg font-semibold">
